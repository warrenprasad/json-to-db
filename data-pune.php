...
$sql = "SELECT MAX(hist_data_time_set_id) from testw1.hist_data_01 where hist_data_city_id = 1;";
...
else
{
	$timeset = 1;
        ...
        $condition = $forecast->getHistoricalConditions(18.5204, 73.8567, $rowtime['time_set_unix']);
		...
		VALUES ('1', $timecheck , '$summary', '$icon', $mintemp, $maxtemp, $hum, $timeset )";
